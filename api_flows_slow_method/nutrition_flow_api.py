...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("nutrition_flow.log"),
...
FLOW_ID = "c48cc605-1adb-48ad-b6ff-273b06faf353"
APPLICATION_TOKEN = os.getenv("APPLICATION_TOKEN")
ENDPOINT = ""  # You can set a specific endpoint name in the flow settings

# Default goals and notes
...
TWEAKS = {
    "TextInput-pZFfT": {"input_value": notes},
    "TextInput-Jan01": {"input_value": goals},
...
def main():
    ...
    try:
        ...
        save_json_data(extra, "nutrition_principles_1.json")
        
        schedule = response['outputs'][0]['outputs'][0]['outputs']['text']['message']
        save_json_data(schedule, "nutrition_plan_1.json")
