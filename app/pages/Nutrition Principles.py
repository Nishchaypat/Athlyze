...
st.set_page_config(page_title="Athlyze | Nutrition Principles", page_icon="public/favicon.svg", layout="wide")
...
def load_training_principles():
    ...
    file_path = "database/your_nutrition_principles.json"
